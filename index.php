...
//$dadosCafe = $produtoRepositorio->opçoesCafe();
//$dadosAlmoco = $produtoRepositorio->opçoesAlmoco();

$dadosCafe = $produtoRepositorio->buscarProdutosPorTipo('cafe');
$dadosAlmoco = $produtoRepositorio->buscarProdutosPorTipo('almoco');
